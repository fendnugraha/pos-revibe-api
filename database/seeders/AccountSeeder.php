...
class AccountSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $accounts = [
            ...
            ['code' => '30100', 'name' => 'Ekuitas', 'status' => 'K', 'type' => 'Equity'],
            ['code' => '40100', 'name' => 'Penjualan Barang Dan Jasa', 'status' => 'K', 'type' => 'Revenue'],
            ['code' => '40200', 'name' => 'Potongan Pembelian', 'status' => 'K', 'type' => 'Revenue'],
            ['code' => '40300', 'name' => 'Pendapatan Lainnya', 'status' => 'K', 'type' => 'Revenue'],
            ['code' => '40400', 'name' => 'Retur Penjualan & Penalti', 'status' => 'K', 'type' => 'Revenue'],
            ['code' => '50100', 'name' => 'Beban Pemakaian Bahan Baku', 'status' => 'D', 'type' => 'COGS'],
            ['code' => '50200', 'name' => 'Beban Penyedia Jasa Subkontrak', 'status' => 'D', 'type' => 'COGS'],
            ['code' => '60101', 'name' => 'Beban Gaji Langsung', 'status' => 'D', 'type' => 'Expenses'],
            ['code' => '60102', 'name' => 'Beban Upah Tenaga Kontrak Langsung (Pulsa)', 'status' => 'D', 'type' => 'Expenses'],
            ['code' => '60103', 'name' => 'Beban Konsultan, Tenaga Ahli Dan Agen Pulsa', 'status' => 'D', 'type' => 'Expenses'],
            ['code' => '60104', 'name' => 'Beban Gaji Overhead Pulsa', 'status' => 'D', 'type' => 'Expenses'],
            ['code' => '60105', 'name' => 'Beban Bahan Pendukung Usaha', 'status' => 'D', 'type' => 'Expenses'],
            ['code' => '60106', 'name' => 'Beban Sewa Alat & Pengiriman', 'status' => 'D', 'type' => 'Expenses'],
            ['code' => '60107', 'name' => 'Beban Perjalanan Dinas', 'status' => 'D', 'type' => 'Expenses'],
            ['code' => '60108', 'name' => 'Beban Keselamatan Kerja', 'status' => 'D', 'type' => 'Expenses'],
            ['code' => '60109', 'name' => 'Beban Pemeliharaan Dan Perbaikan Aset Tetap', 'status' => 'D', 'type' => 'Expenses'],
            ['code' => '60110', 'name' => 'Beban Lain-Lain', 'status' => 'D', 'type' => 'Expenses'],
            ['code' => '60111', 'name' => 'Pengurangan Penjualan', 'status' => 'D', 'type' => 'Expenses'],
            ['code' => '60112', 'name' => 'Beban Board Of Director (Bod)', 'status' => 'D', 'type' => 'Expenses'],
            ['code' => '60113', 'name' => 'Beban Lain-Lain Corporate', 'status' => 'D', 'type' => 'Expenses']
        ];
