...
class WarehouseController extends Controller
{
    ...
    {
        $warehouses = Warehouse::with(['ChartOfAccount', 'primaryCashAccount'])
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            ChartOfAccount::where('id', $request->acc_code)->update(['warehouse_id' => $warehouse->id, 'is_primary_cash' => true]);
    ...
    public function update(Request $request, Warehouse $warehouse)
    {
        ...
        try {
            ...
            // Update the related ChartOfAccount with the warehouse ID
            ChartOfAccount::where('id', $request->chart_of_account_id)->update(['warehouse_id' => $warehouse->id, 'is_primary_cash' => 1]);
    ...
    {
        $warehouses = Warehouse::where('is_active', 1)->orderBy('name', 'asc')->get();
        return response()->json([
            'success' => true,
            'data' => $warehouses
        ], 200);
