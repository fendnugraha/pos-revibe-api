...
class ChartOfAccountController extends Controller
{
    ...
    public function updateWarehouseId(Request $request, $id)
    {
        //toggle warehouse id
        $chartOfAccount = ChartOfAccount::find($id);
        $chartOfAccount->warehouse_id = $chartOfAccount->warehouse_id == null ? $request->warehouse_id : null;
        $chartOfAccount->save();

        return new DataResource($chartOfAccount, true, "Successfully updated chart of account");
    }
}
